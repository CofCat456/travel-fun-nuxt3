...
const goProducts = () => router.push({ name: 'country-name-products-catgory' })
</script>

<template>
  <Banner :bg-url="getBackgroundUrl" center multiply>
    <template #title>
      {{ getCountryName }}
    </template>
    <template #sec-title>
  ...
  />
  <LazySwiperProduct :products="getFilterData(getByRecommended)" title="為您推薦" />
  <LazySwiperProduct
  ...
  <LazySwiperCity :title="`${getCountryName}熱門城市`" />
</template>
